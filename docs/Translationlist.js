function Translationlist() {
    var zurete = ["ずれていく","Wowaka",[""],["Japanese ","Romaji ","English ","どこかに消えた屍， ","dokoka ni kieta shikabane, ","A corpse that dissappeared to somewhere","その間に逃げ出したいだけ ","sono ma ni nigedashitai dake ","Just wanting to run away into that space","はにかみ顔の背中の ","hanikami gao no senaka no ","You, the back of the shy face,","あなたの感覚ってずれてる。 ","anata no kankakutte zureteru ","your sensation is deviating","","","","間違い探しに終われ， ","machigai sagashi ni oware ","Finished with looking for mistakes","1，2の3の掛け声 ","ichi, ni no san no kakegoe ","A shout of 1, 3/2","「足りないもの」 ",'"tarinai mono"','"Something’s lacking"',"お洒落でしょ？って ","oshare deshou? tte ","Saying it’s stylish, right? ","駆け出す足音 ","kakedasu ashioto ","The ringing staccaratta","が鳴るのスッタカラッタ ","ga naru no suttaka ratta ","of sprinting footsteps","","","","右側の半分がずれて ","migigawa no hanbun ga zurete ","The right half deviated","左側に溶け込んでった。 ","hidarigawa ni tokekondetta ","Melded into the left half","はにかむ顔に腹立て， ","hanikamu kao ni haratate, ","Getting angry at the shy face,","何様気取りの傍観者は言うよ ","nanisama kidori no boukansha wa iu yo ","a self-important bystander will say","","","","そう ","sou ","That’s right","あなたのこと ","anata no koto ","I’ve come","きらいになったのです。 ","kirai ni natta no desu ","to hate you","","","","「どこかに消えた」しかだめ？ ","""dokoka ni kieta"" shika dame? ","Is just “it disappeared somewhere” no good?","その場に連れ出したいだけ ","sono ba ni tsuredashitai dake ","Just wanting to take it with me to that place","割れない窓を叩くのって ","warenai mado o tatakunotte ","Saying to hit an unbreakable window","あなたの感覚を疑いましたよ ","anata no kankaku o utagai mashita yo ","I distrusted your sensation","","","","右側の半分がずれて ","migigawa no hanbun ga zurete ","The right half deviated","左側に溶け込んでった。 ","hidarigawa ni tokekondetta ","Melded into the left half","はにかむ顔に腹立て， ","hanikamu kao ni haratate, ","Getting angry at the shy face,","何様気取りの傍観者が言うよ ","nanisama kidori no boukansha ga iu yo ","a self-important bystander is saying","","","","ずれていく ","zurete iku ","We’re diverging","とりあえず ","toriaezu ","For now","よくわからん ","yoku wakaran ","I don’t really know","ほうこうへ ","houkou e ","In what direction","まるでなにごとも ","marude nani goto mo ","Almost as if there isn’t","ないかのよに ","nai ka no yo ni ","anything at all","","","","間違い探しの痛い，痛い ","machigai sagashi no itai, itai ","The pain, pain of looking for mistakes","傷跡が ","kizuato ga ","The scars","勘違いだらけの日常になる ","kanchigai darake no nichijou ni naru ","are becoming a daily life full of misunderstandings","勘違い探しを，強いたい　見たい ","kanchigai sagashi o shiitai, mitai, ","I want to force, see, a search for misunderstandings","ひとりきり ","hitorikiri ","All on my own","何だろうと覗き込む力を ","nandarou to nozoki komu chikara o ","The power to look into what it was"]];
    ...
    var CSVListTitle = [zurete[0],atowo[0],oneEight[0]];
    var CSVListAuthor = [zurete[1],atowo[1],oneEight[1]];
    var notes = [zurete[2],atowo[2],oneEight[2]];
    var CSVS = [zurete[3],atowo[3],oneEight[3]];
